...
namespace SamplesRepository.UserCode
{
    ...
    static SamplesConfiguration()
    {
        dbConnectionString = ConfigurationManager.ConnectionStrings["SampleRepo"].ConnectionString;
        dbProviderName = ConfigurationManager.ConnectionStrings["SampleRepo"].ProviderName;
